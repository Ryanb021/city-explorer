    ...
    return (
      <>
        <header>
          ...
          <h2>Before committing crime of Grand Theft, check out the latest weather information of your favorite city to terrorize. Plus... bonus of movies history information! Enjoy gangsters! </h2>
        </header>
        <main>
          <Forms
